...
class U2NET(nn.Module):
    def __init__(self, in_channels=3, num_classes=1):
        ...
        self.side1 = nn.Conv2d(64, num_classes, kernel_size=3, padding=1)
        self.side2 = nn.Conv2d(64, num_classes, kernel_size=3, padding=1)
        self.side3 = nn.Conv2d(128, num_classes, kernel_size=3, padding=1)
        self.side4 = nn.Conv2d(256, num_classes, kernel_size=3, padding=1)
        self.side5 = nn.Conv2d(512, num_classes, kernel_size=3, padding=1)
        self.side6 = nn.Conv2d(512, num_classes, kernel_size=3, padding=1)

        self.outconv = nn.Conv2d(num_classes * 6, num_classes, kernel_size=1)
